...
- OS command injection (Also Known as shell injection) is a security vulnerability where an attacker can cause an application to execute unintended operating system commands.
